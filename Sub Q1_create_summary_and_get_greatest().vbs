Sub Q1_create_summary_and_get_greatest()
    Dim ws As Worksheet
    Dim lastRow As Long
    Dim i As Long
...
Next cell
    ...
    ws.Range("Q2").NumberFormat = "0.00%" ' Format as percentage with two decimal places
    ws.Range("Q2").Value = maxPercentage

    ws.Range("O3").Value = "Greatest % Decrease"
    ws.Range("P3").Value = minPercentageTicker
    ws.Range("Q3").NumberFormat = "0.00%" ' Format as percentage with two decimal places
